...
var TDLib = {
  ...
  Screens: __webpack_require__(/*! ./screens */ "./src/screens/index.js"),
...
var Boot = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(Boot, [{
    ...
    value: function create() {
      ...
      this.scene.add(_Settings.default.STARTING_SCENE.key, _Settings.default.STARTING_SCENE, true);
    }
  }]);
...
var _deviceDetectorJs = _interopRequireDefault(__webpack_require__(/*! device-detector-js */ "./node_modules/device-detector-js/dist/index.js"));
...
var Game = /*#__PURE__*/function () {
  function Game(config) {
     ...
     */
    this.config = config;
    var userAgent = navigator.userAgent; // const userAgent = 'Apple-iPhone6C2/1202.440';

    _Settings.default.DEVICE = new _deviceDetectorJs.default().parse(userAgent).device.type;
    _Settings.default.DEVICE = _Settings.default.DEVICE.charAt(0).toUpperCase() + _Settings.default.DEVICE.slice(1);
    if (_Settings.default.DEVICE === 'Smartphone' || _Settings.default.DEVICE === 'Tablet') _Settings.default.DEVICE = 'Mobile';
    ...
    _Settings.default.STARTING_SCENE = this.config.startingScene;
  ...
  _createClass(EffectComponent, [{
    ...
    value: function play(key) {
      ...
      if (key in _effects.default) this.currentEffect = new _effects.default[key](this, config);else if (key in _effects.default.LightEffects) {
        if (this.gameObject instanceof _LightSource.default) {
          if (this.gameObject.isOn) {
            this.currentEffect = new _effects.default.LightEffects[key](this, config);
...
/***/ "./src/managers/LightSourceManager.js":
/*!********************************************!*\
  !*** ./src/managers/LightSourceManager.js ***!
  \********************************************/
/***/ ((module, exports, __webpack_require__) => {
...
var LightSourceManager = /*#__PURE__*/function (_Manager) {
  ...
  function LightSourceManager(room, pluginManager) {
    ...
    return _possibleConstructorReturn(this, (LightSourceManager.__proto__ || Object.getPrototypeOf(LightSourceManager)).call(this, room, pluginManager));
  }
  ...
  _createClass(LightSourceManager, [{
    ...
    value: function add(source) {
      if (source instanceof _LightSource.default) this.lightSources.add(source, true);
    }
    /**
    ...
    key: "calculateLightsContribuiteAtPoint",
    value: function calculateLightsContribuiteAtPoint(target) {
      var contributesAccumulator = 0;
      this.lightSources.getChildren().forEach(function (lightSource) {
        if (lightSource.isOn) {
          // eslint-disable-next-line max-len
          var singleLightContribute = lightSource.diffusedLight.intensity / (Math.abs(lightSource.x + lightSource.config.offset.x - target.x) ^ 2); // Contributo modificato in base all'effetto corrente
    ...
    value: function calculateAverageLightsContribute() {
      ...
      if (this.lightSources !== null) {
        ...
        if (contributesAccumulator !== 0) averageLightsContribute = Math.floor(contributesAccumulator * 10000 / this.room.layers.wallsLayer.width / _Settings.default.TILE_SIZE * 100) / 100 + 0.3;
      }
 ...
 */
var Managers = {
  LayerManager: __webpack_require__(/*! ./LayerManager */ "./src/managers/LayerManager.js"),
  LightSourceManager: __webpack_require__(/*! ./LightSourceManager */ "./src/managers/LightSourceManager.js"),
  Manager: __webpack_require__(/*! ./Manager */ "./src/managers/Manager.js"),
  UpdateManager: __webpack_require__(/*! ./UpdateManager */ "./src/managers/UpdateManager.js")
};
...
var Room = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  _createClass(Room, [{
    ...
    value: function _setCameraViewport() {
      ...
      } else if (_Settings.default.DEVICE === 'Desktop') {
    ...
    value: function _createRoom() {
      ...
      this.layers.backgroundLayer = this.map.createLayer('backgroundLayer', this.map.addTilesetImage(_Utils.default.findFileNameFromPath(this.assets.raw.image.tiles.background.path)), 0, 0).setPipeline('Light2D');
      this.layers.wallsLayer = this.map.createLayer('wallsLayer', this.map.addTilesetImage(_Utils.default.findFileNameFromPath(this.assets.raw.image.tiles.walls.path)), 0, 0); // TODO: valutare se anche per i walls serve la pipeline Light2D

      this.layers.wallsMaskLayer = this.map.createLayer('wallsMaskLayer', this.map.addTilesetImage(_Utils.default.findFileNameFromPath(this.assets.raw.image.tiles.walls.bPath)), 0, 0);
    }
    /**
    ...
    value: function _createSprites() {
      ...
      this.map.objects.forEach(function (layer) {
        layer.objects.forEach(function (element) {
          if (_this5.objects[element.name]) {
            console.error(new Error('Duplicated name for object: ' + element.name));
          } // eslint-disable-next-line


          _this5.objects[element.name] = new _Settings.default.GAME_SPRITES[element.type].default(_this, element.x + element.width / 2, element.y - element.height / 2);

          _this5.objects[element.name].setName(element.name);
        });
      });
    }
    /**
...
var _Room = _interopRequireDefault(__webpack_require__(/*! ../rooms/Room */ "./src/rooms/Room.js"));
 ...
 * @since 1.0.0
 */
var Screen = /*#__PURE__*/function (_Phaser$Scene) {
   ...
   * @param {string} sceneKey - The unique key to identify the room.
   */
  function Screen(sceneKey) {
    var _this;

    _classCallCheck(this, Screen);

    _this = _possibleConstructorReturn(this, (Screen.__proto__ || Object.getPrototypeOf(Screen)).call(this, sceneKey));
    /**
       * The Settings cursor manager.
       * @type {TDLib.Plugins.SettingsPlugins.CursorManager}
       * @since 1.0.0
  ...
  _createClass(Screen, [{
    ...
    value: function create() {
      this.scene.bringToTop('CursorScene');
      console.log('Starting screen:', this.key); // this.layers.setLayersDepth();
    }
    /**
     * The update function is executed at every cycle of the game loop.
     * @since 1.0.0
    ...
    key: "change",
    value: function change(newScene) {
      this.scene.remove(this.key);

      if (newScene.prototype instanceof _Room.default) {
...
var Screens = {
  Screen: __webpack_require__(/*! ./Screen */ "./src/screens/Screen.js")
};
      ...
      _get(HardFlickering.prototype.__proto__ || Object.getPrototypeOf(HardFlickering.prototype), "play", this).call(this, function () {
        var setTimer = function setTimer() {
          _this2.gameObject.room.time.addEvent({
            ...
            callback: function callback() {
              if (!_this2.stopped) {
                if (_this2.gameObject.config.graphicLight !== null) {
                  if (_this2.gameObject.graphicLight.intensity === 0) {
                    _this2.gameObject.graphicLight.setIntensity(_this2.gameObject.config.graphicLight.intensity);
                  } else _this2.gameObject.graphicLight.setIntensity(0);
                }

                if (_this2.gameObject.config.diffusedLight !== null) {
                  if (_this2.gameObject.diffusedLight.intensity === 0) {
                    _this2.gameObject.diffusedLight.setIntensity(_this2.gameObject.config.diffusedLight.intensity);
    ...
    value: function stop() {
      ...
      _get(HardFlickering.prototype.__proto__ || Object.getPrototypeOf(HardFlickering.prototype), "stop", this).call(this, function () {
        if (_this3.config.finalState === 'on') {
          if (_this3.gameObject.config.graphicLight !== null) {
            _this3.gameObject.graphicLight.setIntensity(_this3.gameObject.config.graphicLight.intensity);
          }

          if (_this3.gameObject.config.diffusedLight !== null) {
...
var LightSource = /*#__PURE__*/function (_WorldItem) {
  ...
  function LightSource(room, x, y, texture, layer, graphicLightConfig, diffusedLightConfig, offset) {
    ...
    _this.diffusedLight = null;
    _this.graphicLight = null;
    _this.isOn = false;
...
"use strict";
module.exports = JSON.parse("[{\"regex\":\"NetFront\",\"name\":\"NetFront\"},{\"regex\":\"Edge\",\"name\":\"Edge\"},{\"regex\":\"Trident\",\"name\":\"Trident\"},{\"regex\":\"Blink\",\"name\":\"Blink\"},{\"regex\":\"(?:Apple)?WebKit\",\"name\":\"WebKit\"},{\"regex\":\"Presto\",\"name\":\"Presto\"},{\"regex\":\"(?<!like )Gecko\",\"name\":\"Gecko\"},{\"regex\":\"KHTML\",\"name\":\"KHTML\"},{\"regex\":\"NetSurf\",\"name\":\"NetSurf\"},{\"regex\":\"Servo\",\"name\":\"Servo\"},{\"regex\":\"Goanna\",\"name\":\"Goanna\"}]");
...
"use strict";
module.exports = JSON.parse("{\"Tesla\":{\"regex\":\"(?:Tesla/[0-9.]+|QtCarBrowser)\",\"device\":\"car browser\",\"models\":[{\"regex\":\"QtCarBrowser\",\"model\":\"Model S\"},{\"regex\":\"Tesla/[0-9.]+\",\"model\":\"\"}]}}");
...
const browser_families_json_1 = __importDefault(__webpack_require__(/*! ./fixtures/browser-families.json */ "./node_modules/device-detector-js/dist/parsers/client/fixtures/browser-families.json"));
...
"use strict";
module.exports = JSON.parse("{\"Android Browser\":[\"AN\",\"MU\"],\"BlackBerry Browser\":[\"BB\"],\"Baidu\":[\"BD\",\"BS\"],\"Amiga\":[\"AV\",\"AW\"],\"Chrome\":[\"CH\",\"BA\",\"BR\",\"CC\",\"CD\",\"CM\",\"CI\",\"CF\",\"CN\",\"CR\",\"CP\",\"DD\",\"IR\",\"RM\",\"AO\",\"TS\",\"VI\",\"PT\",\"AS\",\"TB\",\"AD\",\"SB\",\"WP\",\"I3\",\"CV\",\"WH\",\"SZ\",\"QW\",\"LF\",\"KW\",\"2B\",\"CE\",\"EC\",\"MT\",\"MS\",\"HA\",\"OC\",\"MZ\",\"BM\",\"KN\",\"SW\",\"M1\",\"FA\",\"TA\",\"AH\",\"CL\",\"SU\",\"EU\",\"UB\",\"LO\",\"VG\",\"TV\"],\"Firefox\":[\"FF\",\"FE\",\"FM\",\"SX\",\"FB\",\"PX\",\"MB\",\"EI\",\"WF\",\"CU\",\"TF\",\"QM\",\"FR\",\"I4\",\"GZ\",\"MO\",\"F1\",\"BI\",\"MN\",\"BH\",\"TO\",\"OS\",\"FY\"],\"Internet Explorer\":[\"IE\",\"IM\",\"PS\"],\"Konqueror\":[\"KO\"],\"NetFront\":[\"NF\"],\"NetSurf\":[\"NE\"],\"Nokia Browser\":[\"NB\",\"NO\",\"NV\",\"DO\"],\"Opera\":[\"OP\",\"OM\",\"OI\",\"ON\",\"OO\",\"OG\",\"OH\",\"O1\",\"OX\"],\"Safari\":[\"SF\",\"MF\",\"SO\"],\"Sailfish Browser\":[\"SA\"]}");
...
"use strict";
module.exports = JSON.parse("[\"36\",\"OC\",\"PU\",\"SK\",\"MF\",\"OI\",\"OM\",\"DD\",\"DB\",\"ST\",\"BL\",\"IV\",\"FM\",\"C1\",\"AL\",\"SA\",\"SB\",\"FR\",\"WP\",\"HA\",\"NX\",\"HU\",\"VV\",\"RE\",\"CB\",\"MZ\",\"UM\",\"FK\",\"FX\",\"WI\",\"MN\",\"M1\",\"AH\",\"SU\",\"EU\",\"EZ\",\"UT\",\"DT\",\"S0\"]");
